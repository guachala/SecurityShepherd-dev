	...
	<script type="text/javascript" src="../js/clipboard-js/clipboard-events.js"></script>
		<div id="contentDiv">
			...
			<p> 
				...
				<br/>
				<br/>
				${ fn:escapeXml(bundle.getString("challenge.whereIdIsUserBeenIncremented.1")) } ${ fn:escapeXml(bundle.getString("challenge.userIdExample")) } ${ fn:escapeXml(bundle.getString("challenge.whereIdIsUserBeenIncremented.2")) } ${ fn:escapeXml(bundle.getString("challenge.yourIdIs")) } ${ fn:escapeXml(userId) } ${ fn:escapeXml(bundle.getString("challenge.yourCsrfTokenIs")) }  <a>${ fn:escapeXml(csrfChal4Token) }</a>${ fn:escapeXml(bundle.getString("challenge.yourIdIs.1")) }
				<br/>
				<br/>
